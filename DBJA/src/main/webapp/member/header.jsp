...
<div class="header-5Zx">
  <div class="nav-JxW">
    ...
    <div class="divcontainer-Amk">
      <div class="list-gzz">
        <a class="item-link-home-Emc" href="myTrip.do">나의여행</a>
        <a class="information" href="../listInformation.do">여행정보</a>
        <a class="board" href="listPost.do">게시판</a>
        <a class="board" href="listQuestion.do?id=<%="cocomo3" %>">문의하기</a>
      </div>
      <div class="list-iTp">
        <a class="item-link-login-USz" href="../logout.do">로그아웃</a>
        <a class="item-link-sign-up-bnW" href="listMemberInfo.do">마이페이지</a>
      </div>
    </div>
  </div>
</div>
